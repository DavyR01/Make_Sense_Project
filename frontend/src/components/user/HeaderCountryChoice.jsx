...
export default function HeaderCountryChoice() {
  ...
  return (
    <div
      className={` pl-10 sm:pl-20 pr-10 sm:pr-20 h-14 sm:h-12 md:h-8 md:w-screen flex items-center ${dark || !token ? "bg-light-grey" : "bg-dark-header text-white"} text-black justify-between`}
    >
