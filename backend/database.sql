...
('Fixation des prix : Objectif anti-inflation', "<h3><strong style='color: rgb(0, 102, 204);'>Allez dans n’importe quel magasin de détail et vous trouverez des clients qui marchandent les prix.</strong></h3><p><br></p><p><strong>Maintenant, si le propriétaire était lui-même impliqué dans de telles décisions opérationnelles, l’entreprise irait vite à la ruine. </strong></p><p><br></p><p>Au lieu de cela, le propriétaire ou le gestionnaire donne les niveaux de prix et les niveaux de marge qui doivent être maintenus et donc la décision est prise par l’employé.</p>", "<h3><strong style='color: rgb(0, 102, 204);'>Allez dans n’importe quel magasin de détail et vous trouverez des clients qui marchandent les prix.</strong></h3><p><br></p><p><strong>Maintenant, si le propriétaire était lui-même impliqué dans de telles décisions opérationnelles, l’entreprise irait vite à la ruine. </strong></p><p><br></p><h3>Au lieu de cela, le propriétaire ou le gestionnaire donne les niveaux de prix et les niveaux de marge qui doivent être maintenus et donc la décision est prise par l’employé.</h3>", "<h3><strong style='color: rgb(0, 102, 204);'>Allez dans n’importe quel magasin de détail et vous trouverez des clients qui marchandent les prix.</strong></h3><p><br></p><p><strong>Maintenant, si le propriétaire était lui-même impliqué dans de telles décisions opérationnelles, l’entreprise irait vite à la ruine. </strong></p><p><br></p><h3>Au lieu de cela, le propriétaire ou le gestionnaire donne les niveaux de prix et les niveaux de marge qui doivent être maintenus et donc la décision est prise par l’employé.</h3>", "<h3><strong style='color: rgb(0, 102, 204);'>Allez dans n’importe quel magasin de détail et vous trouverez des clients qui marchandent les prix.</strong></h3><p><br></p><p><strong>Maintenant, si le propriétaire était lui-même impliqué dans de telles décisions opérationnelles, l’entreprise irait vite à la ruine. </strong></p><p><br></p><h3>Au lieu de cela, le propriétaire ou le gestionnaire donne les niveaux de prix et les niveaux de marge qui doivent être maintenus et donc la décision est prise par l’employé.</h3>", '2020-05-10 14:36:46', '2020-08-10 05:52:23', '2020-11-02 15:42:23', 'Terminee','4'), 

('Déterminer le montant des remises ', '<p><strong style="background-color: rgb(204, 232, 204);">Dans les ventes de canal ou dans le marketing de réseau, la vente quotidienne ainsi que l’achat quotidien est si élevé en quantité,&nbsp;que les remises jouent un rôle majeur sur quelle marque le concessionnaire va pousser sur le marché. </strong></p><p><br></p><p><span style="background-color: rgb(255, 255, 255); color: rgb(0, 71, 178);">Par conséquent, les managers doivent disposer de toutes les informations sur les niveaux de remise actuels sur le marché et sur les remises à accorder aux distributeurs, qui sont finalement accordées par les dirigeants. </span></p><p><br></p><p><strong style="background-color: rgb(255, 255, 255);">En bref, les opérations au niveau du canal doivent être gérées correctement.</strong></p>', '<p><strong style="color: rgb(0, 71, 178);">Le sujet de&nbsp;cet article n’est pas de se prononcer sur le montant ou le taux de remise à effectuer chaque cas étant particulier, c’est au&nbsp;dirigeant de fixer la politique tarifaire dont font partie les remises commerciales&nbsp;(en tenant compte du cadre réglementaire).</strong></p><p><br></p><p><strong>Par contre il peut être intéressant de se demander jusqu’où peut-on baisser le prix.</strong></p><p><br></p><p><u style="color: rgb(0, 138, 0);">La réponse à cette question se trouve d’une part dans le niveau de connaissance du dirigeant de son coût de revient unitaire, de sa marge (ou son taux de marge), et d’autre part dans la raison de remise effectuée.</u></p>', '<p><strong style="color: rgb(0, 71, 178);">Le sujet de&nbsp;cet article n’est pas de se prononcer sur le montant ou le taux de remise à effectuer chaque cas étant particulier, c’est au&nbsp;dirigeant de fixer la politique tarifaire dont font partie les remises commerciales&nbsp;(en tenant compte du cadre réglementaire).</strong></p><p><br></p><p><strong>Par contre il peut être intéressant de se demander jusqu’où peut-on baisser le prix.</strong></p><p><br></p><p><u style="color: rgb(0, 138, 0);">La réponse à cette question se trouve d’une part dans le niveau de connaissance du dirigeant de son coût de revient unitaire, de sa marge (ou son taux de marge), et d’autre part dans la raison de remise effectuée.</u></p>', '<h3><strong><em><u>La nécessité de connaître le coût de revient unitaire</u></em></strong></h3><p><br></p><p><strong>Avoir une bonne connaissance du coût de revient unitaire permet de bien définir les limites acceptables d’une remise commerciale.&nbsp;</strong>En effet, comment connaître l’impact d’une remise sur la rentabilité d’une vente si on ne connaît pas la structure de coût de ses produits&nbsp;:&nbsp;<a href="https://www.leblogdudirigeant.com/fiche-pratique-gestion-commerciale-marge-taux-de-marge-taux-de-marque/" rel="noopener noreferrer" target="_blank" style="color: var(--purple);">taux de marge</a>, niveau de frais fixe, coût d’achat … </p><p><br></p><p><strong style="color: rgb(0, 71, 178);">N’hésitez pas à consulter nos fiches pratiques sur&nbsp;</strong><a href="https://www.leblogdudirigeant.com/fiche-pratique-gestion-commerciale-cout-de-revient/" rel="noopener noreferrer" target="_blank" style="color: rgb(0, 71, 178);"><strong>le coût de revient</strong></a><strong style="color: rgb(0, 71, 178);">, le taux de marge et&nbsp;</strong><a href="https://www.leblogdudirigeant.com/fiche-pratique-gestion-commerciale-determiner-prix-de-vente/" rel="noopener noreferrer" target="_blank" style="color: rgb(0, 71, 178);"><strong>le calcul du prix de vente.</strong></a></p>', '2021-09-25 12:05:43', '2021-11-20 19:19:58', '2021-12-05 20:25:23', 'En cours','3'),
...
INSERT INTO message_help (username, email, objet, content) 
VALUES 
('Adrien Roussel', 'adrien@gmail.com', 'Je souhaite changer mon email', 'Bonjour est-il possible de changer mon adresse email ?'),
('Daniel Blanchard', 'daniel@gmail.com', 'Comment supprimer mon compte', 'Bonjour, pouvez-vous supprimer mon compte'),
('Constance Boe', 'constance@gmail.com', 'Supprimer ma décision', 'J ai besoin d aide pour supprimer ma décision'),
('Julia Leclerc', 'julia@gmail.com', 'Problème connexion', 'Bonjour depuis ce matin je ne peux pas me connecter'),
('Davy Mccree', 'davy@gmail.com', 'Problème mot de passe', 'Bonjour, je ne retrouve plus mon mot de passe. Comment faire ?'),
('Iris Tracer', 'iris@gmail.com', 'Passage en mode admin', 'Comme convenu est-il possible de me passer en mode admin?'),
('John Doe', 'john@gmail.com', 'Passer Iris en mode admin' , 'Bonjour est-il possible de mettre Iris en admin');
...
-- ou permet de passer une décision en statut 'en cours' si aucun commentaire en vote 'contre' est présent
