...
setInterval(autoUpdateStatusTDecisionTermineeByDateAndVote, 1000 * 10);
...
// execute function 2 minutes
setInterval(autoUpdateStatusTDecisionNonAboutieByDateAndVote, 1000 * 10);
...
// execute function 2 minutes
setInterval(autoUpdateStatusTermineeWithDateConflict, 1000 * 10);
...
// execute function 2 minutes
setInterval(autoUpdateStatusNonAboutieWithDateConflict, 1000 * 10);
